...
import sim.app.exploration.objects.ChargingStation;
...
public class MapperAgent {
	...
	public Vector<ChargingStation> knownChargingStations;
	...
	public MapperAgent(int width, int height){
		...
		this.knownChargingStations = new Vector<ChargingStation>();
	}
	...
	public void addObject(SimObject obj) {
		...
		if (obj.getClass()==ChargingStation.class) {
