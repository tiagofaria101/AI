...
public class ChargingStation extends SimObject{
    ...
    public ChargingStation(int x, int y){
        super(new Int2D(x,y), new Color(255, 249,0), size);
        this.introduceRandomness(RED_DELTA, GREEN_DELTA, BLUE_DELTA, SIZE_DELTA);

    }

    public ChargingStation(Int2D loc, Color color, double size){
    ...
    public static Portrayal getPortrayal(){
        ...
        return new RectanglePortrayal2D(new Color(255, 249,0),size);
